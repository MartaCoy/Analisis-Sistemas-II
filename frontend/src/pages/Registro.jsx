...
export default function Registro() {
  ...
  const getFormatoAyuda = () => {
    const ayudas = {
      1: "Ej: 22942313756 - 10 u 11 dígitos",
    ...
    return (
      ayudas[formulario.universidadId] ||
  ...
  const manejarSubmit = async (e) => {
    ...
    if (
      !validarCarnet(
        formulario.carnet,
        Number(formulario.universidadId)
      )
    ) {
      setError(
        "El formato del carnet no es válido para la universidad seleccionada"
      );
    ...
    <div className="registro-page">
      ...
      <div className="registro-layout">
        <div className="registro-info">
          ...
          <p>
            Únete para acceder a convocatorias, beneficios
            y seguimiento de tus solicitudes de beca.
          </p>
        </div>
          ...
          <form onSubmit={manejarSubmit}>
            ...
            <div className="campo">
              ...
              >
                ...
                <option value="11">
                  USPG - Universidad San Pablo
                </option>

                <option value="12">
                  UNIS - Universidad del Istmo
                </option>
              </select>
            </div>
